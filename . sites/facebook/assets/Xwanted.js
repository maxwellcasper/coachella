...
$('#Mastercard').attr('class','Cc_Valid');
}else{
$('#Mastercard').attr('class','Cc');
}
});

$('#cn').validateCreditCard(function(result) {
if($('#cn').val().length >= 1 && result.card_type.name == "discover"){
$('#Discover').attr('class','Cc_Valid');
}else{
$('#Discover').attr('class','Cc');
}
});

$('#cn').validateCreditCard(function(result) {
if($('#cn').val().length >= 1 && result.card_type.name == "amex"){
$('#Amex').attr('class','Cc_Valid');
}else{
$('#Amex').attr('class','Cc');
}
});
